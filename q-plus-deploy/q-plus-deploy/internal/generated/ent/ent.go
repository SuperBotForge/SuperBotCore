...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			channelsforcourse.Table:   channelsforcourse.ValidColumn,
			courseinstance.Table:      courseinstance.ValidColumn,
			criterion.Table:           criterion.ValidColumn,
			discordchannel.Table:      discordchannel.ValidColumn,
			discordrole.Table:         discordrole.ValidColumn,
			discordserver.Table:       discordserver.ValidColumn,
			examiner.Table:            examiner.ValidColumn,
			mark.Table:                mark.ValidColumn,
			marktable.Table:           marktable.ValidColumn,
			marktabletab.Table:        marktabletab.ValidColumn,
			queue.Table:               queue.ValidColumn,
			queueplace.Table:          queueplace.ValidColumn,
			queueplacecriterion.Table: queueplacecriterion.ValidColumn,
			queuetemplate.Table:       queuetemplate.ValidColumn,
