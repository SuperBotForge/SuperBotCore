...
func (uaq *UserAccountQuery) FirstIDX(ctx context.Context) int64 {
...
func (uaq *UserAccountQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (uaq *UserAccountQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(useraccount.Table, useraccount.Columns, sqlgraph.NewFieldSpec(useraccount.FieldID, field.TypeInt64))
	_spec.From = uaq.sql
